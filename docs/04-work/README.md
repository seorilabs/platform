...
교환하고 신규 uid는 서버가 생성한다. 2026-08-02 앱 SA와 resource-level
`roles/iam.serviceAccountTokenCreator`, registry sync, platform-api production 배포를 완료했다.
...
- 남은 운영 gate: App Check 또는 edge rate limit, 실제 기존 사용자·실기기 migration
